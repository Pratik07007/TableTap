                                    ...
                                    <td className="p-4 text-right">
                                        <div className="flex items-center justify-end gap-2">
                                            ...
                                            {!it.isAvailable && (
                                                ...
                                                >
                                                    {togglingId === it.id ? <div className="w-4 h-4 border-2 border-current border-t-transparent rounded-full animate-spin" /> : <Save size={16} />}
                                                </button>
                                            )}
                                            <button
                                                ...
                                                title="Delete Item"
                                            >
                                                {deletingId === it.id ? <div className="w-4 h-4 border-2 border-current border-t-transparent rounded-full animate-spin" /> : <Trash2 size={16} />}
                                            </button>
                                        </div>
                                    </td>
                                </tr>
