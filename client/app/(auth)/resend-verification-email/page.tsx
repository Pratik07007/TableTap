...
export default function Page() {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            console.log("Error from resend-verification-email", err);
    ...
    return (
        <div className="w-full md:w-1/2 flex items-center justify-center bg-gray-50">
            <div className="w-full max-w-md px-8">
                <h2 className="text-2xl font-semibold text-gray-800 mb-6">Resend verification email</h2>
                <p className="text-gray-600 mb-6">Enter your email to receive a new verification link.</p>
